...
const Styler = styled(Container)`
	...
	.rw-widget-container {
		...
		border-bottom: ${({ theme }) => theme.palette.gray2.regular} 0.063rem solid;
	}
	...
	.rw-state-focus > .rw-widget-container:hover {
		...
		border-bottom: ${({ theme }) => theme.palette.primary.regular} 0.063rem solid;
	}
	...
	.rw-select-bordered {
		cursor: pointer;
		border: none;
		border-left: #ccc 0.063rem solid;
	}
	...
	.rw-rtl .rw-select-bordered {
		border-right: #ccc 0.063rem solid;
		border-left: none;
	}
	.rw-rtl {
		direction: rtl;
	...
	.rw-widget-input.rw-state-focus {
		box-shadow: 0 0 0.5rem rgba(102, 175, 233, 0.6), inset 0 0.063rem 0.063rem rgba(0, 0, 0, 0.075);
	}
	.rw-list {
		margin: 0;
		padding: 0;
...
*/ 'border: 0.125rem solid red;'
		...
		line-height: calc(1.2145em - 0.063rem);
		display: block;
		border: none;
	}
	...
	.rw-multiselect-tag {
		...
		margin-left: calc(0.279335em - 0.063rem);
		margin-top: 0.279335em;
		margin-top: calc(0.279335em - 0.063rem);
		height: 1.87033em;
	...
	.rw-rtl .rw-multiselect-tag {
		margin-left: 0;
		margin-right: calc(0.279335em - 0.063rem);
		padding: 0 0.35em 0 0.35em;
	}
